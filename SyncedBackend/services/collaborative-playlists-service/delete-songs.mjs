...
import { deleteSongs } from '/opt/nodejs/streaming-service/delete-songs.mjs';
...
async function deleteSongsFromSpotifyPlaylists(songs, collaboratorsData, spotifyUsersMap) {
    ...
    for (const collaborator of collaboratorsSpotifyData) {
        try {
            await deleteSongs(collaborator.spotifyPlaylistId, spotifyUsersMap.get(collaborator.userId), songs, playlistsTable);
        } catch (error) {
